                    ...
                    <div className="double-items">
                        <div className="row align-center">
                            <div className="col-lg-6 info banner-left">
                                <h2>Hey <img src={shape4} alt="Icon" /> I'm <span>Parnell</span></h2>
                                <h3 className="title">
                                ...
                                <div className="button mt-55">
                                    <Link className="btn btn-md circle btn-theme effect" to="resume">My Resume</Link>
                                </div>
                            </div>

                            <div className="col-lg-6 thumb banner-right">
                              <div className="shape-center">
                                <img src={shape7} alt="Icon" />
                              </div>
                              <Fade>
